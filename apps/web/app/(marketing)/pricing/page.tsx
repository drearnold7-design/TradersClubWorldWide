...
const PACKAGES: Package[] = [
  {
    ...
    tagline: 'Join the trip and the lifestyle, without the trading curriculum.',
    features: [
      ...
      { label: 'Live trading sessions with Daniel Gamble', included: false },
      { label: '1-on-1 mentoring & trade breakdowns', included: false },
      { label: 'Morning mindset coaching sessions', included: false },
    ],
  },
  {
